package com.trainingappMob.myapplicationtraining.backend.googleSignIn
...
class GoogleAuthClient(private val applicationContext: Context) {
        ...
        val request = GetCredentialRequest.Builder()
            .addCredentialOption(
                GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId("201716761099-pmjjvl9s1ofvj1c059lng38bkqc31b7g.apps.googleusercontent.com")
